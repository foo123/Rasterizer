...
function intercept_x(y, m, p1/*, p2*/, n, q1/*, q2*/)
{
...
function intercept_y(x, m, p1/*, p2*/, n, q1/*, q2*/)
{
    var //m = -(p2.y - p1.y)/(p2.x - p1.x),
        //n = -(q2.y - q1.y)/(q2.x - q1.x),
        ym = p1.y - m*(x - p1.x),
